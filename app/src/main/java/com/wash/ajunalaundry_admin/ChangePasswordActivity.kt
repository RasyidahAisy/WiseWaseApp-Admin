...
class ChangePasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.checkBox4.setOnCheckedChangeListener { _, isChecked -> // If the checkbox is checked, show the password.
            ...
            binding.editTextTextPassword2.transformationMethod =
                if (isChecked) null else PasswordTransformationMethod.getInstance()
            binding.editTextPasswordSekarang.transformationMethod =
                if (isChecked) null else PasswordTransformationMethod.getInstance()
        ...
        binding.button5.setOnClickListener {
            ...
            if (binding.editTextTextPassword2.length() < 6) {
                Toast.makeText(this, "Password Harus Lebih Dari 6 Karakter", Toast.LENGTH_SHORT)
                    .show()
                return@setOnClickListener
            }

            if (binding.editTextPasswordSekarang.text.isEmpty() || binding.editTextEmail.text.isEmpty()) {
                Toast.makeText(this, "Anda Harus Memasukkan Email Dan Password", Toast.LENGTH_SHORT)
                    .show()
                return@setOnClickListener
            }
            ...
            auth.signInWithEmailAndPassword(
                ...
                user!!.updatePassword(newPassword)
                    .addOnSuccessListener {
                        ...
                        Toast.makeText(
                            this,
                            "Anda Berhasil Mengubah Password Anda",
                            Toast.LENGTH_SHORT
                        ).show()
                        finish()
                    }
